...
target6l = RDK.Item('W6')
target7l = RDK.Item('W7')
target8l = RDK.Item('W8')
target9l = RDK.Item('W9')
target10l = RDK.Item('W10')
target11l = RDK.Item('W11')
...
target6r = RDK.Item('O6')
target7r = RDK.Item('O7')
target8r = RDK.Item('O8')
target9r = RDK.Item('O9')
target10r = RDK.Item('O10')
target11r = RDK.Item('O11')
...
while True:
	...
	if result.multi_hand_landmarks:
		...
		if len(lx_coord) != 0:
			...
			if left_finger_arr == [1,1,0,0,0]:
				cv.putText(img, 'Left: 6', (50,100), cv.FONT_HERSHEY_COMPLEX, 1, (255,0,0), thickness=1)
				white.MoveJ(target6l)
				white.RunInstruction('Program_Done')

			if left_finger_arr == [1,1,1,0,0]:
				cv.putText(img, 'Left: 7', (50,100), cv.FONT_HERSHEY_COMPLEX, 1, (255,0,0), thickness=1)
				white.MoveJ(target7l)
				white.RunInstruction('Program_Done')	

			if left_finger_arr == [1,0,1,0,0]:
				cv.putText(img, 'Left: 8', (50,100), cv.FONT_HERSHEY_COMPLEX, 1, (255,0,0), thickness=1)
				white.MoveJ(target8l)
				white.RunInstruction('Program_Done')		

			if left_finger_arr == [1,0,0,0,1]:
				cv.putText(img, 'Left: 9', (50,100), cv.FONT_HERSHEY_COMPLEX, 1, (255,0,0), thickness=1)
				white.MoveJ(target9l)
				white.RunInstruction('Program_Done')	
	
			if left_finger_arr == [0,0,1,1,1]:
				cv.putText(img, 'Left: 10', (50,100), cv.FONT_HERSHEY_COMPLEX, 1, (255,0,0), thickness=1)
				white.MoveJ(target10l)
				white.RunInstruction('Program_Done')

			if left_finger_arr == [1,1,0,0,1]:
				cv.putText(img, 'Left: 11', (50,100), cv.FONT_HERSHEY_COMPLEX, 1, (255,0,0), thickness=1)
				white.MoveJ(target11l)
				white.RunInstruction('Program_Done')		
		...
		if len(rx_coord) != 0:
			...
			if right_finger_arr == [1,1,0,0,0]:
				cv.putText(img, 'Right: 6', (450,100), cv.FONT_HERSHEY_COMPLEX, 1, (0,0,255), thickness=1)
				orange.MoveJ(target6r)
				orange.RunInstruction('Program_Done')	

			if right_finger_arr == [1,1,1,0,0]:
				cv.putText(img, 'Right: 7', (450,100), cv.FONT_HERSHEY_COMPLEX, 1, (0,0,255), thickness=1)
				orange.MoveJ(target7r)
				orange.RunInstruction('Program_Done')		

			if right_finger_arr == [1,0,1,0,0]:
				cv.putText(img, 'Right: 8', (450,100), cv.FONT_HERSHEY_COMPLEX, 1, (0,0,255), thickness=1)
				orange.MoveJ(target8r)
				orange.RunInstruction('Program_Done')

			if right_finger_arr == [1,0,0,0,1]:
				cv.putText(img, 'Right: 9', (450,100), cv.FONT_HERSHEY_COMPLEX, 1, (0,0,255), thickness=1)
				orange.MoveJ(target9r)
				orange.RunInstruction('Program_Done')	

			if right_finger_arr == [0,0,1,1,1]:
				cv.putText(img, 'Right: 10', (450,100), cv.FONT_HERSHEY_COMPLEX, 1, (0,0,255), thickness=1)
				orange.MoveJ(target10r)
				orange.RunInstruction('Program_Done')

			if right_finger_arr == [1,1,0,0,1]:
				cv.putText(img, 'Right: 11', (450,100), cv.FONT_HERSHEY_COMPLEX, 1, (0,0,255), thickness=1)
				orange.MoveJ(target11r)
				orange.RunInstruction('Program_Done')	
